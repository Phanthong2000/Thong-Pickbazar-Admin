...
function BoxSearchShipping({ handleFilter }: Props) {
  return (
    <div className="d-flex align-items-center row box_shadow_card bg_white p-4 border_radius_3">
      <div className="col-12 col-lg-3 font_family_bold font20">Shippings</div>
...
export default React.memo(BoxSearchShipping);
