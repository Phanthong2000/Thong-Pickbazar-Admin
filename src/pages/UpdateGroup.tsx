...
function UpdateGroup() {
    ...
    const onSubmit = (data: any) => {
        if (sliders.length === 0 && newSliders.length === 0) setErrorImage("Must choose promotional sliders");
        else if (gallery.length === 0 && newGallery.length === 0) setErrorImage("Must choose gallery banner");
        else {
            setErrorImage("");
            dispatch(
