...
function Category() {
    ...
    const handleFilter = (value: any, text: string) => {
        if (value) {
            setCategories(allCategories.filter((category: any) => category.name_en.toLowerCase().includes(text.toLowerCase()) && category.group.name_en === value.value))
        } else {
            setCategories(allCategories.filter((category: any) => category.name_en.toLowerCase().includes(text.toLowerCase())))
        }
    }
    ...
    return (
        <>
            ...
            <BaseTableCategory handleDelete={handleDelete} handleUpdate={handleUpdate} data={categories} />
        </>
    )
}
